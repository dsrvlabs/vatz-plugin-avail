...
const (
	...
	defaultBlockDiff = 3
	pluginName       = "check_blockheight"
	methodName       = "AvailGetBlockHeight"
)
...
func pluginFeature(info, option map[string]*structpb.Value) (sdk.CallResponse, error) {
	...
	if err != nil {
		...
		contentMSG = "Fail to get Block Height at first time"
	...
	if errParse != nil {
		...
		severity = pluginpb.SEVERITY_ERROR
		log.Error().
			Str(methodName, "Parsing Error from Current Block Height").
			Msg(pluginName)
	}
